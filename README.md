...
2. \`deep_insight/assets/model에 recognition_resnet27.onnx\`를 다운 받아서 ㅓ흐세요
...
6. 종료하려면 \`l\` 키 누르고 \`Ctrl + C\`를 입력하세요.
